...
Keywords: settings, ticker, server start, server stop, lifecycle, TICKER_HANDLER, connection screen, MSSP
...
## Key Files
- `settings.py` — Minimal overrides: SERVERNAME, INSTALLED_APPS (+world), all 6 BASE_*_TYPECLASS paths, imports `secret_settings`
