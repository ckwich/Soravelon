...
detect_skill_domain() {
    ...
    if [[ "$file" =~ /banking ]] || [[ "$file" =~ /models ]] || [[ "$file" =~ /commands/ ]] || [[ "$file" =~ /test_banking ]]; then
        detected_skills="banking"
    elif [[ "$file" =~ /world_state ]] || [[ "$file" =~ /mob_disposition ]] || [[ "$file" =~ /models ]]; then
        detected_skills="faction-system"
    elif [[ "$file" =~ /group_engine ]] || [[ "$file" =~ /test_group_engine ]] || [[ "$file" =~ /commands/ ]]; then
        detected_skills="group-system"
    elif [[ "$file" =~ /inventory_engine ]] || [[ "$file" =~ /inventory_helpers ]] || [[ "$file" =~ /objects ]] || [[ "$file" =~ /models ]]; then
        detected_skills="inventory-engine"
    elif [[ "$file" =~ /objects ]]; then
        detected_skills="item-typeclasses"
    elif [[ "$file" =~ /loot_tables ]] || [[ "$file" =~ /group_engine ]] || [[ "$file" =~ /zone_scaling ]]; then
        detected_skills="loot-tables"
    elif [[ "$file" =~ /mob_affixes ]] || [[ "$file" =~ /mob_affix_roller ]] || [[ "$file" =~ /mobs ]]; then
        detected_skills="mob-affix-system"
    elif [[ "$file" =~ /mob_disposition ]] || [[ "$file" =~ /mobs ]] || [[ "$file" =~ /test_mob_disposition ]]; then
        detected_skills="mob-disposition"
    elif [[ "$file" =~ /node_script ]] || [[ "$file" =~ /node_helpers ]] || [[ "$file" =~ /node_effects ]] || [[ "$file" =~ /zone_object ]] || [[ "$file" =~ /rooms ]]; then
        detected_skills="node-system"
    elif [[ "$file" =~ /settings ]] || [[ "$file" =~ /at_server_startstop ]] || [[ "$file" =~ /at_initial_setup ]] || [[ "$file" =~ /connection_screens ]] || [[ "$file" =~ /conf/ ]]; then
        detected_skills="server-conf"
    elif [[ "$file" =~ /world_state ]] || [[ "$file" =~ /mob_disposition ]] || [[ "$file" =~ /models ]] || [[ "$file" =~ /characters ]]; then
        detected_skills="world-state-engine"
    elif [[ "$file" =~ /world_state ]] || [[ "$file" =~ /models ]] || [[ "$file" =~ /zone_scaling ]] || [[ "$file" =~ /zone_object ]] || [[ "$file" =~ /test_world_state ]]; then
        detected_skills="zone-attunement"
    elif [[ "$file" =~ /zone_scaling ]] || [[ "$file" =~ /zone_object ]] || [[ "$file" =~ /test_zone_scaling ]]; then
        detected_skills="zone-scaling"
    fi
