...
world/           # Game logic — models, engines, helpers, migrations
  areas/         # Zone spec files (declarative Python DSL via AreaBuilder)
...
| **Mob Templates** | Mob stat templates, template application | `.claude/skills/mob-templates/skill.md` |
...
| **Skill Definitions** | General proficiency skills, trainers, ancestry seeds | `.claude/skills/skill-definitions/skill.md` |
...
| **Area Builder** | Declarative zone DSL, rooms, exits, spawns, NPCs | `.claude/skills/area-builder/skill.md` |
