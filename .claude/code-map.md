...
- `world\area_builder.py` — 3 dependents
...
- **tests\test_area_builder.py** (7 files): `world\area_builder.py`, `world\__init__.py`, `world\area_validator.py`, `tests\test_area_builder.py`, `tests\test_zone_serializer.py`
...
*145 files, 48 edges — updated 2026-03-28*
