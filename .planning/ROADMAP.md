...
- [ ] 13-05-PLAN.md — Fishing system (CmdFish active + idle modes, CmdReel)
- [ ] 13-06-PLAN.md — Prospect/survey + Sense gathering hints + tool repair + command registration
...
| 13. Gathering and Refining | 3/7 | In Progress|  |
