...
`fb76c88`, `c3d9f1e`, `d3ddc32`, and `845617e`
...
`c3d9f1e`, `d3ddc32`, or `845617e`; their evidence is the exact clean-clone
gates above. GitHub Actions is required only for the native package
