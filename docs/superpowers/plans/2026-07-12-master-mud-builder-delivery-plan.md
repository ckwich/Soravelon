...
`c3d9f1e`, or `d3ddc32`; their evidence is the exact clean-clone gates above.
GitHub Actions is required only for the native package certification matrix,
not for Lightsail hosting or live-game uptime.
