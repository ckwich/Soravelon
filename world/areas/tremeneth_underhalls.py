...
def build():
    ...
    dl_slow_bell_08 = area.room('dl_slow_bell_08', name='Weather Bell', desc='This slow bell is tested only after surface weather and cistern levels are posted beside it. Years of records expose correlations, exceptions, and missing days without turning any one pattern into a promised cause.', room_type='underground', indoor=True)
