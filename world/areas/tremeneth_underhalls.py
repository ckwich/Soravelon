...
def build():
    ...
    # NPCs
    _underhall_archivist = area.npc(ug_underhall_gate, 'npc_underhall_archivist_nelli', name='Underhall Archivist Nelli', faction='resonance', dialogue={'greeting': 'Nelli waits until your lantern is steady before she hands you any history.', 'topics': {'measure': 'A careful measure is a promise to return the name with the number.'}, 'base_hints': []})
