...
def build():
    ...
    area.exit(ca_queue_lane, ca_caravan_court, "north")
    area.exit(ca_caravan_court, ca_queue_lane, "south")
    ...
    area.exit(oc_teamsters_hall, oc_broker_steps, "north")
    area.exit(oc_broker_steps, oc_teamsters_hall, "south")
    area.exit(oc_hawkers_walk, oc_artisans_court, "west")
    area.exit(oc_artisans_court, oc_hawkers_walk, "east")

    area.exit(oc_scale_square, mw_decree_wall, "north")
    area.exit(mw_decree_wall, oc_scale_square, "south")
    ...
    area.exit(mw_ink_store, mw_petition_cloister, "east")
    area.exit(mw_petition_cloister, mw_ink_store, "west")
    area.exit(mw_petition_cloister, mw_review_court, "north")
    area.exit(mw_review_court, mw_petition_cloister, "south")
    ...
    area.exit(mw_public_records, mw_records_arcade, "south")
    area.exit(mw_records_arcade, mw_public_records, "north")

    area.exit(oc_scale_square, mq_barracks_yard, "east")
    area.exit(mq_barracks_yard, oc_scale_square, "west")
    ...
    area.exit(mq_armorers_hall, mq_forge_bay, "north")
    area.exit(mq_forge_bay, mq_armorers_hall, "south")
    area.exit(mq_supply_depot, mq_ration_house, "south")
    area.exit(mq_ration_house, mq_supply_depot, "north")
    area.exit(mq_ration_house, mq_pay_window, "west")
    area.exit(mq_pay_window, mq_ration_house, "east")
    ...
    area.exit(ca_relief_yard, mq_stables, "east")
    area.exit(mq_stables, ca_relief_yard, "west")

    area.exit(mq_barracks_yard, dc_outer_yard, "north")
    area.exit(dc_outer_yard, mq_barracks_yard, "south")
    ...
    area.exit(dc_quarantine_pens, dc_repair_bay, "east")
    area.exit(dc_repair_bay, dc_quarantine_pens, "west")
    ...
    area.exit(dc_signal_cage, dc_weather_balcony, "north")
    area.exit(dc_weather_balcony, dc_signal_cage, "south")
    ...
    area.exit(dc_cargo_loft, dc_repair_bay, "east")
    area.exit(dc_repair_bay, dc_cargo_loft, "west")
    area.exit(dc_officers_gallery, dc_observation_walk, "south")
    area.exit(dc_observation_walk, dc_officers_gallery, "north")
    area.exit(mq_orders_desk, dc_dispatch_office, "north")
    area.exit(dc_dispatch_office, mq_orders_desk, "south")
    ...
    area.exit(cd_survey_cloister, cd_lecture_ambulatory, "west")
    area.exit(cd_lecture_ambulatory, cd_survey_cloister, "east")
    ...
    area.exit(nh_mirror_green, nh_garden_terrace, "south")
    area.exit(nh_garden_terrace, nh_mirror_green, "north")
    ...
    area.exit(nh_patron_registry, nh_carriage_court, "north")
    area.exit(nh_carriage_court, nh_patron_registry, "south")
    area.exit(nh_carriage_court, nh_lodge_office, "east")
    area.exit(nh_lodge_office, nh_carriage_court, "west")
    area.exit(nh_guest_loggia, nh_guest_garden, "east")
    area.exit(nh_guest_garden, nh_guest_loggia, "west")
    area.exit(nh_guest_garden, nh_hunt_map_gallery, "north")
    area.exit(nh_hunt_map_gallery, nh_guest_garden, "south")
    area.exit(nh_hunt_map_gallery, nh_lodge_office, "east")
    area.exit(nh_lodge_office, nh_hunt_map_gallery, "west")
    area.exit(oc_hawkers_walk, nh_kitchen_court, "east")
    area.exit(nh_kitchen_court, oc_hawkers_walk, "west")
    area.exit(cd_reagent_garden, nh_guest_garden, "east")
    area.exit(nh_guest_garden, cd_reagent_garden, "west")
    ...
    area.exit(mw_registry_annex, hw_print_cellar, "down", hidden=True)
    area.exit(hw_print_cellar, mw_registry_annex, "up", hidden=True)
    ...
    area.exit(dc_restricted_tunnel, hw_sump_bridge, "west", hidden=True)
    area.exit(hw_sump_bridge, dc_restricted_tunnel, "east", hidden=True)
    ...
    area.exit(hw_culvert_crossing, hw_sluice_gate, "east")
    area.exit(hw_sluice_gate, hw_culvert_crossing, "west")
