...
def build():
    ...
    ac_courier_platform = area.room('ac_courier_platform', name='Courier Platform', desc='Korahei opens in circles rather than gates, with palms, woven shade, and benches placed so strangers meet faces before rules. This part of the Arrival Circle centers on courier platform, where couriers compare tide routes beside painted stones. Every path bends back toward welcome, but the welcome asks guests to notice what they take and what they owe.', room_type='clearing')
    ...
    ac_reef_gate = area.room('ac_reef_gate', name='Reef Gate', desc='Korahei opens in circles rather than gates, with palms, woven shade, and benches placed so strangers meet faces before rules. This part of the Arrival Circle centers on reef gate, where elders watch arrivals without making a spectacle of caution. Every path bends back toward welcome, but the welcome asks guests to notice what they take and what they owe.', room_type='clearing')
    ...
    kg_kiai_gate = area.room('kg_kiai_gate', name='Kiai Gate', desc='The northern city path grows quieter as council circles give way to the road used by caretakers, witnesses, and candidates. This part of the Kiai Gate and Tide Council Walk centers on kiai gate, where polished stones carry marks from many patient feet. Nothing here sells the kiai as a prize; the city treats preparation as responsibility before wonder.', room_type='path')
    ...
    lt_paddle_pattern_rack = area.room('lt_paddle_pattern_rack', name='Paddle Pattern Rack', desc='Terraces climb toward work circles where carving, mending, and quiet listening are treated as civic skills. This part of the Listening Terraces and Craft Rings centers on paddle pattern rack, where craft scraps are sorted instead of wasted. The terraces make the city feel learned without becoming a schoolhouse; knowledge is shared by sitting close and doing the work.', room_type='building')
    ...
    lt_soft_hammer_ring = area.room('lt_soft_hammer_ring', name='Soft Hammer Ring', desc='Terraces climb toward work circles where carving, mending, and quiet listening are treated as civic skills. This part of the Listening Terraces and Craft Rings centers on soft hammer ring, where shade sails turn the sun into warm moving patterns. The terraces make the city feel learned without becoming a schoolhouse; knowledge is shared by sitting close and doing the work.', room_type='building')
    lt_shared_tool_shelf = area.room('lt_shared_tool_shelf', name='Shared Tool Shelf', desc='Terraces climb toward work circles where carving, mending, and quiet listening are treated as civic skills. This part of the Listening Terraces and Craft Rings centers on shared tool shelf, where students leave room for elders to correct their hands. The terraces make the city feel learned without becoming a schoolhouse; knowledge is shared by sitting close and doing the work.', room_type='building')
    lt_repair_song_niche = area.room('lt_repair_song_niche', name='Repair Song Niche', desc='Terraces climb toward work circles where carving, mending, and quiet listening are treated as civic skills. This part of the Listening Terraces and Craft Rings centers on repair song niche, where craft scraps are sorted instead of wasted. The terraces make the city feel learned without becoming a schoolhouse; knowledge is shared by sitting close and doing the work.', room_type='building')
    ...
    lt_central_path = area.room('lt_central_path', name='Central Path', desc='Terraces climb toward work circles where carving, mending, and quiet listening are treated as civic skills. This part of the Listening Terraces and Craft Rings centers on central path, where shade sails turn the sun into warm moving patterns. The terraces make the city feel learned without becoming a schoolhouse; knowledge is shared by sitting close and doing the work.', room_type='building')
    ...
    qh_ruins_boat = area.room('qh_ruins_boat', name='Ruins Boat', desc='The south of Korahei lowers its voice around the Quiet House, where grief, remembrance, and hospitality share the same bowls. This part of the Quiet House and Southern Boat Path centers on ruins boat, where the surf below carries a hush different from the market. The path toward the ruins is not hidden, but the city expects players to approach it with humility instead of treasure fever.', room_type='building')
