...
def build():
    ...
    gc_soft_mud_print = area.room('gc_soft_mud_print', name='Soft Mud Print', desc='Soft mud keeps crisp prints from birds, lizards, and travelers who thought the bend was new. The ground itself becomes a guide, if players slow down enough to read it.', room_type='path')
