...
def build():
    ...
    # Rooms
    ps_patrol_stair = area.room('ps_patrol_stair', name='Patrol Stair', desc='Patrol Stair belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The patrol stair is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_breathing_niche = area.room('ps_breathing_niche', name='Breathing Niche', desc='Breathing Niche belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The breath niche is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_rope_bell_03 = area.room('ps_rope_bell_03', name='Rope Bell 03', desc='Rope Bell 03 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The rope bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_old_boot_04 = area.room('ps_old_boot_04', name='Old Boot 04', desc='Old Boot 04 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The old boot is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_thin_air_05 = area.room('ps_thin_air_05', name='Thin Air 05', desc='Thin Air 05 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The thin air is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_patrol_stair_06 = area.room('ps_patrol_stair_06', name='Patrol Stair 06', desc='Patrol Stair 06 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The patrol stair is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_breath_niche_07 = area.room('ps_breath_niche_07', name='Breath Niche 07', desc='Breath Niche 07 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The breath niche is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_rope_bell_08 = area.room('ps_rope_bell_08', name='Rope Bell 08', desc='Rope Bell 08 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The rope bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_old_boot_09 = area.room('ps_old_boot_09', name='Old Boot 09', desc='Old Boot 09 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The old boot is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_thin_air_10 = area.room('ps_thin_air_10', name='Thin Air 10', desc='Thin Air 10 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The thin air is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_patrol_stair_11 = area.room('ps_patrol_stair_11', name='Patrol Stair 11', desc='Patrol Stair 11 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The patrol stair is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_breath_niche_12 = area.room('ps_breath_niche_12', name='Breath Niche 12', desc='Breath Niche 12 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The breath niche is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_rope_bell_13 = area.room('ps_rope_bell_13', name='Rope Bell 13', desc='Rope Bell 13 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The rope bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ps_old_boot_14 = area.room('ps_old_boot_14', name='Old Boot 14', desc='Old Boot 14 belongs to the Patrol Stair, where patrols learn to count breath, bell, and weather before pride. The old boot is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_storm_bells = area.room('sb_storm_bells', name='Storm Bells', desc='Storm Bells belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The storm bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_frosted_clapper = area.room('sb_frosted_clapper', name='Frosted Clapper', desc='Frosted Clapper belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The frosted clapper is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_weather_oath_03 = area.room('sb_weather_oath_03', name='Weather Oath 03', desc='Weather Oath 03 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The weather oath is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_ringing_ice_04 = area.room('sb_ringing_ice_04', name='Ringing Ice 04', desc='Ringing Ice 04 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The ringing ice is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_low_thunder_05 = area.room('sb_low_thunder_05', name='Low Thunder 05', desc='Low Thunder 05 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The low thunder is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_storm_bell_06 = area.room('sb_storm_bell_06', name='Storm Bell 06', desc='Storm Bell 06 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The storm bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_frosted_clapper_07 = area.room('sb_frosted_clapper_07', name='Frosted Clapper 07', desc='Frosted Clapper 07 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The frosted clapper is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_weather_oath_08 = area.room('sb_weather_oath_08', name='Weather Oath 08', desc='Weather Oath 08 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The weather oath is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_ringing_ice_09 = area.room('sb_ringing_ice_09', name='Ringing Ice 09', desc='Ringing Ice 09 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The ringing ice is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_low_thunder_10 = area.room('sb_low_thunder_10', name='Low Thunder 10', desc='Low Thunder 10 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The low thunder is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_storm_bell_11 = area.room('sb_storm_bell_11', name='Storm Bell 11', desc='Storm Bell 11 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The storm bell is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_frosted_clapper_12 = area.room('sb_frosted_clapper_12', name='Frosted Clapper 12', desc='Frosted Clapper 12 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The frosted clapper is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_weather_oath_13 = area.room('sb_weather_oath_13', name='Weather Oath 13', desc='Weather Oath 13 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The weather oath is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    sb_ringing_ice_14 = area.room('sb_ringing_ice_14', name='Ringing Ice 14', desc='Ringing Ice 14 belongs to the Storm Bells, where weather becomes audible before it becomes lethal. The ringing ice is not decoration; it teaches route sense, local memory, and the practical caution that keeps Tremeneth stories grounded in play. Old stone, half-dwarf stewardship, and signs of Imperial extraction all remain visible here without turning mystery into an answer key.', room_type='path', indoor=False)
    ...
    area.quest(
        ...
        rewards=[{'action_type': 'give_scales', 'amount': 36}, {'action_type': 'modify_standing', 'faction_id': 'verdance', 'delta': 18}],
        next_quest_id=None,
        prerequisite_quests=[],
        can_share=True,
