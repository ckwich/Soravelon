...
def build():
    ...
    sk_wind_rung_04 = area.room('sk_wind_rung_04', name='Wind-Vote Rung', desc='One bridge rung is fitted with ribbons at ankle, waist, and shoulder height. Their disagreement matters more than any single gust: Maro’s slate lists crossings delayed when upper air pulled one way and the deck-level current pulled another.', room_type='path', indoor=False)
