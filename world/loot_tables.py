    ...
    "bandit": {
        ...
        "drops": [
            ...
            },
            {
                ...
                "weight": 0.5,
                "weight_in_pool": 1,
                "value_by_tier":  [10, 25, 50, 100, 200],
                "rarity_by_tier": ["normal", "magic", "rare", "rare", "legendary"],
                "desc_by_tier": [
                    "A trinket that might be worth something.",
                    "An ornate item clearly stolen from someone.",
                    "An ancient relic, pilfered from a collection.",
                    "A valuable artifact with historical markings.",
                    "A priceless relic from a forgotten age.",
                ],
            },
        ],
    },
