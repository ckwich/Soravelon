...
WEBSOCKET_CLIENT_PORT = _env_int("WEBSOCKET_CLIENT_PORT", 4002)
WEBSERVER_INTERNAL_PORT = _env_int("WEBSERVER_INTERNAL_PORT", 4005)
WEBSERVER_PORTS = [(_env_int("WEBSERVER_PORT", 4001), WEBSERVER_INTERNAL_PORT)]
SSH_PORTS = [_env_int("SSH_PORT", 4004)]
